                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="cart">
                            ...
                            <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary">{{ \Cart::getContent()->count() }} items</span>
                            </h1>
                                    ...
                                    <tr class="cart_item">
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <div class="cart-product__item">
                                                <a href="#">
                                                    <img src="{{ asset('app/img/book1.png') }}" alt="product"
                                        ...
                                        <td class="product-quantity">
                                            ...
                                            <div class="quantity">
                                                <a href="{{ route('cart.decr',[$product->id, $product->quantity]) }}" class="quantity-minus">-</a>
                                                <input title="Qty" class="email input-text qty text" type="text"
                                                       value="{{ $product->quantity }}" readonly>
                                                <a href="{{ route('cart.incr', [$product->id, $product->quantity]) }}" class="quantity-plus">+</a>
                                            </div>
